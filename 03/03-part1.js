  ...
  pathInstructions.forEach((instruction) => {
    ...
    while (numSpaces > 0) {
      ...
      if (allCoordinatesTouched[xCoord][yCoord] === undefined) {
        allCoordinatesTouched[xCoord][yCoord] = [wireNumber];
      } else if (!allCoordinatesTouched[xCoord][yCoord].includes(wireNumber)) {
        allCoordinatesTouched[xCoord][yCoord].push(wireNumber)
        intersectionsArray.push([xCoord, yCoord]);
      }
    }
  })
